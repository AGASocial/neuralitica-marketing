...
blocked_reason: null
updated_at: 2026-08-31T02:40:00Z
```
...
| US-12.2 Mark manual publication done | BUILD | branch `feature/US-12.2-mark-published` · CONTRACT `c8d9adb` · FE signoff `4b7754c` · VALIDATE next |
