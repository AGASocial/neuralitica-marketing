...
**Canonical acceptance criteria:** [`plan/USER_STORIES.md`](../../USER_STORIES.md) → US-16.1 (checked on CLOSE only).

**This folder:** [`plan/stories/US-16.1/`](./) — `README.md` · `TASKS.md` → then `SPEC-REVIEW.md` · `SECURITY.md` · `CONTRACT.md` · `VALIDATION.md` · `QA.md`.
