      ...
      return (
        <ApprovalPackageView
          ...
          copy={{
            ...
            confirmApproveHeader: t.approvals.detail.confirmApproveHeader,
            confirmApproveMessage: t.approvals.detail.confirmApproveMessage,
            confirmApprove: t.approvals.detail.confirmApprove,
            cancelApprove: t.approvals.detail.cancelApprove,
            ...
            readyToPublish: {
              title: t.readyToPublish.panel.title,
              subtitle: t.readyToPublish.panel.subtitle,
              downloadVideo: t.readyToPublish.panel.downloadVideo,
              downloadCaption: t.readyToPublish.panel.downloadCaption,
              viewDetail: t.readyToPublish.panel.viewDetail,
              downloadHint: t.readyToPublish.panel.downloadHint,
            },
